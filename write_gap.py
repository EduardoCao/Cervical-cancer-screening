...
def write_gap(MODEL, image_size, lambda_func=None):
    ...
    train_generator = gen.flow_from_directory("output_resize_64", image_size, shuffle=False, 
                                              batch_size=16)
    test_generator = gen.flow_from_directory("output_test_64", image_size, shuffle=False, 
